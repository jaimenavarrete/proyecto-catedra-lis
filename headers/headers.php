        ...
        echo '
            <header>
                <div id="navegador">
                    ...
                    <a href="perfil_estudiante.php"><img class="circular--squaremin" src="img/user.png" /></a>
        ...
        echo '
            <header>
                <div id="navegador">
                    <input type="checkbox" id="menu-bar">
                    <label for="menu-bar" class="fa fa-bars icon" style="font-size:36px"></label>
                    <a href="perfil_docente.php"><img class="circular--squaremin" src="img/user.png" /></a>
                    <a href="logout.php" class="cerrar">Cerrar Sesión <i class="fa fa-sign-out icon"></i> </a>
                    <nav class="menu">
                        <ul>
                        <div class="separador-links">
                            ...
                            <li><a href="crear_grupos.php">Crear grupos<i class="fa fa-pencil-square-o icon"></i></a></li>
                            </div>
                        </ul>
                    </nav>
                </div>
        ...
        echo '
            <header>
                <div id="navegador">
                    <input type="checkbox" id="menu-bar">
                    <label for="menu-bar" class="fa fa-bars icon" style="font-size:36px"></label>
                    <a href="perfil_admin.php"><img class="circular--squaremin" src="img/user.png" /></a>
                    <a href="logout.php" class="cerrar">Cerrar Sesión <i class="fa fa-sign-out icon"></i> </a>
                    <nav class="menu">
                        <ul>
                        <div class="separador-links">
