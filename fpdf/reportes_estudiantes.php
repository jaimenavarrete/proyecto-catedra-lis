<?php
	...
	$num=0;
	$query = "SELECT Nombres_estudiante, Apellidos_estudiante, Usuario_estudiante, Correo, COUNT(Usuario_estudiante) Materias FROM 
	...
	$pdf->Cell(150,100, 'Reporte Estudiantes',0,0,'L');
	$pdf->Ln(60);
	$pdf->SetX(7.5);
	...
	$pdf->Cell(30,10,'MATERIAS',0,1,'C',1);
	...
	while($row = $resultado->fetch_assoc())
	{
		...
		$pdf->Cell(50,10,utf8_decode($row['Correo']),0,0,'C',1);
		$pdf->Cell(30,10,utf8_decode($row['Materias']),0,1,'C',1);
	}
